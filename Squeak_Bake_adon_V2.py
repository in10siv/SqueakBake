...
class SqueakBake(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if sqspeaker :
            ...
            for i,x in enumerate(range(st-1,en)):
                ...
                if ante == post :
                    ...
                    if sta == True :
                        if Squeaktool.zero_bool: sqeak_track(context)
                    sta = False
                ...
                if ante > post:
                    ...
                    if scade == True  and sta == False:
                        if Squeaktool.minus_bool: sqeak_track(context)
                    scade = False
                ...
                if ante < post:
                    ...
                    if creste == True and sta==False :
                        if Squeaktool.plus_bool: sqeak_track(context)
                    creste = False
